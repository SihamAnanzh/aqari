          ...
          <div className="navbar">
            <div className="main-nav">
              <ul className="main-nav-items">
                ...
                <li
                  className={`${
                    route.asPath === "/packages" ? "activeNav" : ""
                  }`}
                >
                  <Link href="/packages" className="main-nav-item">
                    <span
                      className={`${
                        route.asPath === "/packages" ? "active" : ""
                      }`}
                    >
                      {navOb.nav3}
                    </span>
                ...
                {session.data == null && (
                  <Link href="/signIN" className="main-nav-item">
                    <li
                      className={`${
                        route.asPath === "/signIN" ? "activeNav" : ""
                      }`}
                    >
                      <span
                        className={`${
                          route.asPath === "/signIN" ? "active" : ""
                        }`}
                      >
                        {navOb.nav4}
                      </span>
                ...
                <li
                  className={`${route.asPath === "/signUp" ? "activeNav" : ""}`}
                >
                  {session.data == null ? (
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Link
                          href="/profile/addService"
                          className="add-adds-item"
                        >
