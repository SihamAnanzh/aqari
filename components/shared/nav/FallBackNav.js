...
{navOb.nav2}</span></Link>
        ...
        >
          <li
            style={{ cursor: "pointer" }}
            className={`${route.asPath === "/packages" ? "activeNavFall" : ""}`}
          >
            <span className={`${route.asPath === "/packages" ? "active" : ""}`}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <li style={{ textDecoration: "none" }}>English</li>
              </a>
            </Link>
        ...
        <Link
          href={token != "null" ? "/profile" : "/signIN"}
          className="main-nav-item"
        >
          <li
            className={`${route.asPath === "/signIN" ? "activeNavFall" : ""}`}
            onClick={() => setLogin(true)}
          >
            <span className={`${route.asPath === "/signIN" ? "active" : ""}`}>
              {token != "null" ? <img src="/assets/img/profile-nav.svg" /> : ""}
              {token != "null" ? navOb.nav7 : navOb.nav4}
            </span>
          </li>
        </Link>
        ...
        {token != "null" ? (
          ...
          >
            <div className="main-nav-item">
              <span className={`${route.asPath === "/signUp" ? "active" : ""}`}>
