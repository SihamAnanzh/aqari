...
const Contactus = () => {
  ...
  let contactOb = {
    ...
    messageEmpty: t("contactus:messageEmpty"),
    statusW: t("contactus:statusW"),
    messageEmail: t("contactus:messageEmail"),
    messagePhone: t("contactus:messagePhone"),
    sendStatus: t("contactus:sendStatus"),
    messageContact: t("contactus:messageContact"),
    footerDesc,
  };
